...
class LoanRequestView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        current_loan_count = Transaction.objects.filter(
            account=self.request.user.accounts,transaction_type=3,loan_approve=True).count()
        ...
        send_transaction_email(self.request.user, amount, "loan Request Message", "loan_request_email.html")
        return super().form_valid(form)
